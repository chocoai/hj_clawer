...
# 将所有JSON房源信息列表打乱顺序后以JSON格式继续存入文件中
# java -DMODE=SHUFFLE_RESOURCE －DREPORT_DATE=2015-10-10 -jar hj_clawer-0.0.1-SNAPSHOT-jar-with-dependencies.jar 
